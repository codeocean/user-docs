...
![](<.gitbook/assets/docs diagram.png>)
...
* **Start with the Essentials:** If you’re new to Code Ocean, we recommend beginning with the [Onboarding](onboarding/) section. Here you'll gain a solid foundation in navigating the platform and using its core functionality through links to quick videos, full tutorials, and detailed guides.
...
* **Troubleshooting:** Need help working through an issue? Start by using the documentation's search functionality at the top of the page. If you're unable to find the answer to your question, feel free to reach out to our support team at [support@codeocean.com](mailto:support@codeocean.com).
* **Stay Informed:** Code Ocean is constantly evolving! Be sure to check the [Release Notes](https://app.gitbook.com/s/a5AT4eq2XLAGmfb36GJm/) section to stay updated on new features and improvements. You can also join our slack workspace [here](https://codeoceancommunity.slack.com/join/shared_invite/zt-1t4k91nhg-kLNklHRbgadXl4NNqMv4hw).

### User guide feedback

We welcome your feedback. To help us improve this guide, email your suggestions along with the user guide version and page title to [documentation@codeocean.com](mailto:documentation@codeocean.com).
